...
const DEMO_DATA = [
  {
    ...
    content:
      "This place is exactly like the picture posted on Dapio. Great service, we had a great stay!",
  },
  {
    id: 2,
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="What our tenants say about their experience" isCenter>
        Testimonials
      </Heading>
              ...
              <AnimatePresence initial={false} custom={direction}>
                ...
                >
                  <>
                    ...
                    <div className="flex items-center space-x-2 text-lg mt-2 text-neutral-400 dark:text-neutral-500">
