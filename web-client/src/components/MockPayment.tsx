...
export default function MockPayment({ amount, description, onPaymentComplete }: MockPaymentProps) {
    ...
    const handlePayment = () => {
        ...
        // Simulate M-Pesa STK Push and payment processing
        setTimeout(() => {
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-start gap-2 text-xs text-neutral-500 dark:text-neutral-400">
                    ...
                    <p>
                        This is a MOCK payment for demonstration. In production, real M-Pesa integration will be used.
                    </p>
                </div>
            </div>
        </div>
