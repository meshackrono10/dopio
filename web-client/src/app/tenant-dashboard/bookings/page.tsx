...
export default function BookingsPage() {
    ...
    const handleConfirmMeetup = async (bookingId: string) => {
        try {
            ...
            showToast("success", "You've confirmed your arrival at the meeting point!");
        } catch (error) {
            showToast("error", "Failed to confirm arrival");
        }
    };
    ...
    const handleMarkDone = async (bookingId: string) => {
        try {
            ...
            showToast("success", "Viewing marked as completed!");
        } catch (error) {
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-neutral-500 dark:text-neutral-400 mt-1">
                        Track your confirmed and completed property viewings
                    </p>
                </div>
                <div className="text-sm text-neutral-500 dark:text-neutral-400">
                    {tenantBookings.length} total bookings
                </div>
            </div>
            ...
            {tenantBookings.length === 0 ? (
                <div className="bg-white dark:bg-neutral-800 rounded-xl p-12 border border-neutral-200 dark:border-neutral-700 text-center">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-400 mt-2">
                        Your bookings will appear here once a House Hunter accepts your viewing request.
                    </p>
                    <Link
                        href={"/listing-stay" as Route}
                        className="inline-block mt-6 px-6 py-3 bg-primary-600 text-white rounded-xl font-medium"
                    >
                        Browse Properties
                    </Link>
                </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mt-4">
                                        ...
                                        <div>
                                            <p className="text-xs text-neutral-500 dark:text-neutral-400">Amount Paid</p>
                                        ...
                                        <div>
                                            ...
                                            <p className="font-medium">{new Date(booking.scheduledDate).toLocaleDateString()} at {booking.scheduledTime}</p>
                                        </div>
                                        <div>
                                            <p className="text-xs text-neutral-500 dark:text-neutral-400">Booking ID</p>
                                            <p className="font-medium text-xs font-mono">{booking.id.split('-')[0]}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-2 mt-4">
                                        ...
                                        {(booking.status === "confirmed" || booking.status === "in_progress") && !booking.physicalMeetingConfirmed && (
                                            ...
                                            >
                                                IM AT THE MEETING POINT
                                            </button>
                                        )}

                                        {booking.physicalMeetingConfirmed && !booking.tenantDone && (
                                            <button
