            ...
            <main className="pt-11">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                        ...
                        <p>
                            By accessing and using House Haunters, you accept and agree to be bound by the terms and
                            provision of this agreement. If you do not agree to these Terms of Service, please do not use our platform.
                        </p>

                        <h2>2. Description of Service</h2>
                        <p>
                            House Haunters is a platform that connects tenants seeking rental properties with verified house haunters
                        ...
                        <ul>
                            ...
                            <li><strong>House Haunter Account:</strong> For verified agents conducting property viewings</li>
                        </ul>

                        <h2>4. House Haunter Verification</h2>
                        <p>
                            All house haunters must undergo verification including:
                        </p>
                        <ul>
                        ...
                        <ul>
                            <li>The house haunter fails to show up</li>
                            <li>The property does not exist or is misrepresented</li>
                            <li>Technical errors prevent service delivery</li>
                        </ul>

                        <h3>5.2 House Haunter Payments</h3>
                        <p>
                            House haunters receive 80% of the viewing fee. Payments are processed via M-Pesa within 24 hours of
                        ...
                        <p>
                            House haunters are responsible for the accuracy of property listings. We do not verify the accuracy
                        ...
                        <ul>
                            ...
                            <li>House haunters who repeatedly cancel may be suspended or removed</li>
                        </ul>
                        ...
                        <p>
                            House Haunters shall not be liable for any indirect, incidental, special, consequential, or punitive
                            damages resulting from your use of the platform.
                        </p>

                        <h2>12. Indemnification</h2>
                        <p>
                            You agree to indemnify and hold House Haunters harmless from any claims, damages, or expenses arising
                        ...
                        <p>
                            ...
                            <br />
                            Email: legal@househaunters.co.ke
                            <br />
                    ...
                    <div className="mt-12 p-6 bg-primary-50 dark:bg-primary-900/10 rounded-2xl">
                        <p className="text-sm text-neutral-600 dark:text-neutral-300">
                            By using House Haunters, you acknowledge that you have read, understood, and agree to be bound by
