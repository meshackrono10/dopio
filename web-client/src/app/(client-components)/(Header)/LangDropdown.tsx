...
// Currency data (moved from deleted CurrencyDropdown.tsx)
export const headerCurrency = [
  { id: "USD", name: "USD", icon: BanknotesIcon, href: "##", active: true },
  { id: "KES", name: "KES", icon: BanknotesIcon, href: "##" },
  { id: "EUR", name: "EUR", icon: BanknotesIcon, href: "##" },
  { id: "GBP", name: "GBP", icon: BanknotesIcon, href: "##" },
];
