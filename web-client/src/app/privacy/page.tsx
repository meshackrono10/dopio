export default function PrivacyPage() {
    return (
        <div className="nc-PrivacyPage container pb-24 lg:pb-32">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                        ...
                        <ul>
                            ...
                            <li>Log data (pages visited, time spent, clicks)</li>
                        ...
                        <ul>
                            <li>Viewing bookings and payment history</li>
                        ...
                        <p>After account deletion, we may retain some information for:</p>
                        <ul>
                    ...
                    <div className="mt-12 p-6 bg-blue-50 dark:bg-blue-900/10 rounded-2xl">
                        <h3 className="font-semibold mb-2 text-blue-800 dark:text-blue-300">
                            Your Privacy Matters
                        </h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-300">
                            We are committed to transparency and protecting your data. If you have any concerns about how we handle
