    ...
    tenant: [
        {
            ...
            description: 'Create a search request with your budget, location preferences, and property requirements.',
        },
        {
            id: 2,
            icon: 'people',
            title: 'Receive Bids from Hunters',
            description: 'Professional house hunters review your request and submit competitive bids with their service fees and estimated timeframes.',
        },
        {
            id: 3,
            icon: 'checkmark-circle',
            title: 'Accept a Bid',
            description: 'Review bids, check hunter ratings and reviews, then accept the best offer. Payment is held securely in escrow.',
        },
        {
            id: 4,
            icon: 'camera',
            title: 'Review Property Evidence',
            description: 'Your hunter searches for properties and uploads photos, videos, and details for your review.',
        },
        {
            id: 5,
            icon: 'home',
            title: 'Visit & Decide',
            description: 'Schedule viewings for properties you like. Approve the evidence when satisfied, and payment is released to the hunter.',
        },
    ],
    hunter: [
        {
        ...
        },
        {
            id: 2,
            icon: 'list',
            title: 'Browse Search Requests',
            description: 'View available tenant requests matching your area of expertise and availability.',
        },
        {
            id: 3,
            icon: 'pricetag',
            title: 'Submit Competitive Bids',
            description: 'Bid on requests with your service fee and estimated completion time. Stand out with a compelling cover message.',
        },
        {
            id: 4,
            icon: 'search',
            title: 'Find Properties',
            description: 'Once your bid is accepted, search for properties that match the tenant\'s requirements.',
        },
        {
            id: 5,
            icon: 'cloud-upload',
            title: 'Upload Evidence',
            description: 'Share photos, videos, and details of suitable properties. Tenant reviews and approves your work.',
        },
        {
            id: 6,
            icon: 'cash',
            title: 'Get Paid',
            description: 'Once evidence is approved, payment is released to your wallet. Withdraw via M-Pesa anytime.',
        },
    ],
};
