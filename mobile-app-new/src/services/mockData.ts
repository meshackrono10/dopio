...
// Export utility function to get search requests by hunter ID
export const getSearchRequestsByHunterId = (hunterId: string | number) => {
    return MOCK_SEARCH_REQUESTS.filter((request) => request.hunterId === hunterId);
};
